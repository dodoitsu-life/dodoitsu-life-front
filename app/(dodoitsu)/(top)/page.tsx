...
export default function TopPage() {
  return (
    <section id="site-discription">
      <Card>
        <div className="m-8">
          <h1 className="mb-5 text-2xl lg:text-3xl text-gray-900 flex justify-center">
            都々逸ライフ
          </h1>
          <p className="mb-10 text-md lg:text-xl text-gray-500 sm:text-lg flex justify-center">
